...
if __name__ == "__main__":
    ...
    train_accuracies_most_certain = [] if args.model in CTM_LSTM_MODELS else None
    test_accuracies_most_certain = [] if args.model in CTM_LSTM_MODELS else None
                ...
                with (
                        ...
                        for inferi, (inputs, targets) in enumerate(loader):
                            ...
                            if args.model == "ctm":
                                ...
                                all_predictions_list.append(
                                    these_predictions.argmax(1).detach()
                                )  # Shape (B, T)
                    ...
                    if args.model in CTM_LSTM_MODELS:
                        ...
                        current_train_accuracies = (
                            (all_predictions == all_targets.unsqueeze(-1))
                            .float()
                            .mean(dim=0)
                            .cpu()
                            .numpy()
                        ...
                        all_predictions_most_certain = torch.cat(
                        ...
                        current_train_accuracies = (
                            (all_targets == all_predictions).float().mean().item()
                        )  # Shape scalar
                        train_accuracies.append(current_train_accuracies)
